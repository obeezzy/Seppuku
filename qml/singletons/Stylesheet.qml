...
Item {
    ...
    readonly property string fontLocation: "../../assets/fonts/"
    readonly property string defaultFontFamily: defaultFontLoader.name
    readonly property string headerFontFamily: defaultFontLoader.name
    ...
    FontLoader {
        id: tutorFontLoader
        source: fontLocation + "gabriola/Gabriola.ttf"
    }

    FontLoader {
        id: hintFontLoader
        source: fontLocation + "lobster/Lobster.ttf"
    }
